...
typedef struct
{
  __vo uint32_t _CRL;                //Port configuration register low      0x00
  __vo uint32_t _CRH;                //Port configuration register high     0x04
  __vo uint32_t _IDR;                //input data register                  0x08
  __vo uint32_t _ODR;                //output data register                 0x0c
  __vo uint32_t _BSRR;               //bit set/reset register               0x10
  __vo uint32_t _BRR;                //bit reset register                   0x14
  __vo uint32_t _LCKR;               //Port configuration lock register     0x18
}GPIO_RegDef_t;
